...
public class RoundScoreController {
	...
	public List<Score> listScores(@PathVariable("id") Long roundId) {
		return scoreRepository.findByRound_Id(roundId);
	}

	@PostMapping("/{id}/scores")
	@PreAuthorize("hasRole('REFEREE')")
	public ResponseEntity<?> createScore(@PathVariable("id") Long roundId, @Valid @RequestBody CreateScoreRequest body) {
		...
		// 1) Validar que el team participa en ese round (registered)
		...
		// 2) Un solo score por round/team
